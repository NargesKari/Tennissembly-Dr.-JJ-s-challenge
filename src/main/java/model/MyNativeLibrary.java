...
public class MyNativeLibrary {
    ...
    public native static double calculateParabola(double time, double a, double b, double c);
    ...
    public native static double makeInBound(double m, double max, double min);
